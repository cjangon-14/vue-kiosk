...
const getActivityColor = (type) => {
  const colorMap = {
    ...
    'Store Updated': 'text-indigo-600',
    'Category Added': 'text-cyan-600',
    'Category Updated': 'text-cyan-600',
    'Category Deleted': 'text-cyan-600',
    'Product Added': 'text-emerald-600',
    'Product Updated': 'text-emerald-600',
    'Product Deleted': 'text-emerald-600',
    'Menu Added': 'text-amber-600',
    'Menu Updated': 'text-amber-600',
    'Menu Deleted': 'text-amber-600',
    'Inventory Updated': 'text-fuchsia-600',
...
const getActivityBgColor = (type) => {
  const colorMap = {
    ...
    'Store Updated': 'bg-indigo-50',
    'Category Added': 'bg-cyan-50',
    'Category Updated': 'bg-cyan-50',
    'Category Deleted': 'bg-cyan-50',
    'Product Added': 'bg-emerald-50',
    'Product Updated': 'bg-emerald-50',
    'Product Deleted': 'bg-emerald-50',
    'Menu Added': 'bg-amber-50',
    'Menu Updated': 'bg-amber-50',
    'Menu Deleted': 'bg-amber-50',
    'Inventory Updated': 'bg-fuchsia-50',
